...
CREATE INDEX IF NOT EXISTS study_notes_scripture_book_idx ON study_notes(scripture_book);
CREATE INDEX IF NOT EXISTS study_notes_tags_idx ON study_notes USING GIN(tags);
CREATE INDEX IF NOT EXISTS study_log_log_date_idx ON study_log(log_date);
CREATE INDEX IF NOT EXISTS study_log_scripture_book_idx ON study_log(scripture_book);
...
DROP TRIGGER IF EXISTS update_study_log_updated_at ON study_log;
